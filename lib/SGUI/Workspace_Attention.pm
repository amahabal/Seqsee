...
ConfigNames: {
        ElementsYFraction MinGpHeightFraction MaxGpHeightFraction MetoYFraction RelnZenithFraction
            BarlineHeightFraction
    }
Variables: {
        ElementsY MinGpHeight MaxGpHeight BarlineTop BarlineBottom MetoY SpacePerElement
            GroupHtPerUnitSpan AttentionDistribution
    }
InitialCode: {
        use Smart::Comments;
        my %Id2Obj;

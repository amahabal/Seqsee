...
my $EffectiveHeight;
my $EffectiveWidth;
my ( $MaxRows, $MaxColumns, $RowHeight, $ColumnWidth );
...
BEGIN {
    ...
    ( $MaxRows, $MaxColumns, $NameOffset, $CountOffset, $UrgencyOffset, $HistoricalFractionOffset )
        = @CoderackOptions{ 'MaxRows', 'MaxColumns', 'NameOffset', 'CountOffset', 'UrgencyOffset',

...
is       $SWorkspace::elements[2]->{'m'}, 3;
is       $SWorkspace::elements[2]->{left_edge}, 2;
is       $SWorkspace::elements[2]->{right_edge}, 2;
...
is       $SWorkspace::elements[5]->{'m'}, 6;
is       $SWorkspace::elements[5]->{left_edge}, 5;
is       $SWorkspace::elements[5]->{right_edge}, 5;

SWorkspace->setup(8, 9, 10, 11);
is       $SWorkspace::elements_count, 4;
isa_ok   $SWorkspace::elements[2], "SElement";
isa_ok   $SWorkspace::elements[2], "SInt";
is       $SWorkspace::elements[2]->{'m'}, 10;
is       $SWorkspace::elements[2]->{left_edge}, 2;
is       $SWorkspace::elements[2]->{right_edge}, 2;

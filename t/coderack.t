...
ok( SCoderack->get_last_bucket == 9 );
ok( SCoderack->get_urgencies_sum == 0 );

SCoderack->add_codelet($cl_def);
ok( SCoderack->get_last_bucket == 0 );
ok( SCoderack->get_urgencies_sum == 10 );
ok( SCoderack->get_buckets()->[0][0] eq $cl_def );
ok( SCoderack->get_bucket_sum()->[0] == 10 );
...
ok( SCoderack->get_last_bucket == 2 );
ok( SCoderack->get_urgencies_sum == 45 - $urg );
ok( SCoderack->get_bucket_sum()->[0] == 10 or $urg == 10 );

...
my ($RowHeight, $ColumnWidth, $MaxRows, $MaxColumns, $NameOffset, $CountOffset, $UrgencyOffset, $HistoricalFractionOffset);
    ...
    BEGIN {
        ...
        ($MaxRows, $MaxColumns, $NameOffset, $CountOffset, $UrgencyOffset, $HistoricalFractionOffset) = @layout_options{ qw{MaxRows MaxColumns NameOffset CountOffset UrgencyOffset HistoricalFractionOffset} };
    }

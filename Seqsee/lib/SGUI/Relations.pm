{
  ...
  my (
    $row_height,      $ystart,           $end1_x,     $end2_x,
    $strength_x,      $simplicity_x,     $type_x,     $rectangle_left,
    $rectangle_right, $RowCount,         $End1Offset, $End2Offset,
    $StrengthOffset,  $SimplicityOffset, $TypeOffset, $Font
  );
  ...
  BEGIN {
    ...
    (
      $RowCount, $End1Offset, $End2Offset, $StrengthOffset, $SimplicityOffset,
      $TypeOffset, $Font
    )
    = @layout_options{
      qw{RowCount End1Offset End2Offset StrengthOffset SimplicityOffset TypeOffset Font}
    };
  }

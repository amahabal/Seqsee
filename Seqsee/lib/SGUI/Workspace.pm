{
  ...
  my (
    $ElementsY,           $MinGpHeight,         $MaxGpHeight,
    $BarlineTop,          $BarlineBottom,       $MetoY,
    $SpacePerElement,     $GroupHtPerUnitSpan,  $ElementsYFraction,
    $MinGpHeightFraction, $MaxGpHeightFraction, $MetoYFraction,
  ...
  BEGIN {
    ...
    (
      $ElementsYFraction, $MinGpHeightFraction, $MaxGpHeightFraction,
      $MetoYFraction,     $RelnZenithFraction,  $BarlineHeightFraction
    )
    = @layout_options{
      qw{ElementsYFraction MinGpHeightFraction MaxGpHeightFraction MetoYFraction RelnZenithFraction BarlineHeightFraction}
    };
  }

...

{
  ...
  sub Style::Element {
    scalar(@_) == 1 or confess "Needed exactly 1 arguments!";
    my ($hilit) = @_;
    return (
      -fill => do {
        if ( $hilit == 1 ) {
...

{
  ...
  sub Style::Starred {
    scalar(@_) == 0 or confess "Expected no arguments!";
    return (
      -fill   => do { HSV( 240, 50, 50 ) },
      -anchor => do { 'center' },
      -font =>
      do { '-adobe-helvetica-bold-r-normal--20-140-100-100-p-105-iso8859-4' },
    );
  }
...

{
  ...
  sub Style::Relation {
    scalar(@_) == 2 or confess "Needed exactly 2 arguments!";
    my ( $strength, $hilit ) = @_;
    return (
      -width => do { $hilit ? 5         :3 },
...

{
  ...
  sub Style::Group {
    scalar(@_) == 3 or confess "Needed exactly 3 arguments!";
...

{
  ...
  sub Style::GroupBorderAttention {
    scalar(@_) == 0 or confess "Expected no arguments!";
...

{
  ...
  sub Style::ThoughtComponent {
    ...
    return (
      ...
      -font =>
      do { '-adobe-helvetica-bold-r-normal--10-140-100-100-p-105-iso8859-4' },
    );
  }
...

{
  ...
  sub Style::ThoughtHead {
    scalar(@_) == 0 or confess "Expected no arguments!";
    return ( -font =>
      do { '-adobe-helvetica-bold-r-normal--14-140-100-100-p-105-iso8859-4' },
    );
  }
